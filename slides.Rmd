...
# I have to shuffle the edges of net object otherwise the net_line_graph image
# looks beautiful but "weird"
net %>% 
  activate("edges") %>% 
...
The `line graph`. We can use this powerful idea to extract and visualize the first-order binary adjacency matrix of the edges. This type of matrix is used by a CAR or BYM spatial model. 

```{r line_graph, include = FALSE}
net_line_graph <- make_line_graph(net)
first_order_binary_adjacency <- as_adjacency_matrix(net_line_graph)
